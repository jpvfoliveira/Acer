...
{
    public class MaterialReplacementSample : MonoBehaviour
    {
        public MaterialReplacerNodeSettings materialReplacerSettings;
        ...
        void Start()
        {
            ...
            var materialReplacerNode = pipelineAsset.CreateNode<MaterialReplacerNode>();
            materialReplacerNode.settings = materialReplacerSettings;
            ...
            pipelineAsset.CreateConnection(instanceConverter.output, materialReplacerNode.input);
