...
{
    public class AdvancedGameObjectReplacementSample : MonoBehaviour
    {
        public AdvancedGameObjectReplacerNodeSettings gameObjectReplacerSettings;
        ...
        void Start()
        {
            ...
            var gameObjectReplacerNode = pipelineAsset.CreateNode<AdvancedGameObjectReplacerNode>();
            gameObjectReplacerNode.settings = gameObjectReplacerSettings;
            ...
            pipelineAsset.CreateConnection(instanceProvider.output, gameObjectReplacerNode.input);
