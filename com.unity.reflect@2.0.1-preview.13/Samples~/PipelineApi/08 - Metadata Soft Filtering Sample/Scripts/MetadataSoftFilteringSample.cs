...
{
    public class MetadataSoftFilteringSample : MonoBehaviour
    {
        MetadataSoftFilter m_MetadataFilterProcessor;
        ...
        void Start()
        {
            ...
            var filterNode = pipelineAsset.CreateNode<MetadataSoftFilterNode>();
            ...
            pipelineAsset.CreateConnection(instanceProvider.output, filterNode.instanceInput);
