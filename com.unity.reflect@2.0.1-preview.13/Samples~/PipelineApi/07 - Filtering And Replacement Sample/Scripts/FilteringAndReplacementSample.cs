...
{
    public class FilteringAndReplacementSample : MonoBehaviour
    {
        public MetadataFilterSettings metadataFilterSettings;
        ...
        void Start()
        {
            ...
            var filterNode = pipelineAsset.CreateNode<MetadataFilterNode>();
            filterNode.settings = metadataFilterSettings;

            var replacementNode = pipelineAsset.CreateNode<SimpleInstantiatorNode>();
            replacementNode.prefab = replacementPrefab;
            ...
            pipelineAsset.CreateConnection(filterNode.outputTrue, replacementNode.input);
            pipelineAsset.CreateConnection(filterNode.outputFalse, dataProvider.instanceInput);
