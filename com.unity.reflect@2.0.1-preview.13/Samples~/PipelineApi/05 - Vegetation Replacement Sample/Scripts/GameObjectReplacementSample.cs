...
{
    public class GameObjectReplacementSample : MonoBehaviour
    {
        public GameObjectReplacerNodeSettings gameObjectReplacerSettings;
        ...
        void Start()
        {
            ...
            var gameObjectReplacerNode = pipelineAsset.CreateNode<GameObjectReplacerNode>();
